...
namespace Ultilities
{
    public static class Security
    {
        ...
        public static string Encrypt(string plainText, string passPhrase = "Rapid@123")
        {
        ...
        public static string Decrypt(string cipherText, string passPhrase = "Rapid@123")
        {
        ...
        {
            RegistryKey key = Registry.CurrentUser.CreateSubKey(@"SOFTWARE\RapidSolution");
            key.SetValue("DataSource", serverName);
            key.SetValue("InitialCatalog", databaseName);
